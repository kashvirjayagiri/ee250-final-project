...
SERVER = 'http://192.169.0.103:5000'
...
def get_inbox(recipient: str) -> None:
    ...
    Gets mail entries from the server by making a GET request to the /mail/inbox end point with recipient as the parameter

    Parameters:
        recipient: string representing the name of the recipient whose inbox we want to get
...
def get_sent(sender: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Gets mail entries from the server by making a GET request to the /mail/sent end point with sender as the parameter

    Parameters:
        sender: string representing the name of the sender whose 'sent' box we want to get
...
def get_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Gets mail entry from the server by making a GET request to the /mail end point with mail_id as the parameter

    Parameters:
        mail_id: string representing the unique mail id of the mail entry we want to get
...
def delete_mail(mail_id: str) -> None:
    """TODO: fill out this docstring (using the send_mail docstring as a guide)
    Deleted mail entry from the server by making a DELETE request to the /mail end point with mail_id as the parameter

    Parameters:
        mail_id: string representing the unique mail id of the mail entry we want to delete
