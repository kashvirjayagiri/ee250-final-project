...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("jayagiri/ipinfo")
    client.subscribe("jayagiri/dateinfo")
    client.subscribe("jayagiri/timeinfo")
    
    #Add the custom callbacks by indicating the topic and the name of the callback handle
    client.message_callback_add("jayagiri/ipinfo", on_message_from_ipinfo)
    client.message_callback_add("jayagiri/dateinfo", on_message_from_dateinfo)
    # client.message_callback_add("jayagiri/timeinfo", on_message_from_timeinfo)
...
def on_message_from_dateinfo(client, userdata, message):
   print("Custom callback  - Date Info: "+message.payload.decode())

# def on_message_from_timeinfo(client, userdata, message):
#    print("Custom callback  - Time Info: "+message.payload.decode())
